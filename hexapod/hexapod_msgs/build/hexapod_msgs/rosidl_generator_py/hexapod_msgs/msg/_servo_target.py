...
class Metaclass_ServoTarget(type):
    """Metaclass of message 'ServoTarget'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__servo_target
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__servo_target
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__servo_target
            cls._TYPE_SUPPORT = module.type_support_msg__msg__servo_target
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__servo_target
...
class ServoTarget(metaclass=Metaclass_ServoTarget):
    """Message class 'ServoTarget'."""
    ...
    def servo_id(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'servo_id' field must be an integer in [-2147483648, 2147483647]"
